...
export function ScrollSequence() {
  ...
  const images = [
    "/screen6.png", // 0: Hub (Grid)
    "/screen5.png", // 1: Hub (List)
    "/screen4.png", // 2: Length 
    "/screen3.png", // 3: Pressure
    "/screen1.png", // 4: Favorites
    "/screen2.png", // 5: History
  ];
      ...
      <div className="md:hidden flex flex-col py-20 bg-[#080808] gap-24 overflow-hidden border-y border-white/5">
         ...
         <div className="container mx-auto px-6 max-w-sm">
            ...
            <div className="flex justify-center -mb-20 opacity-90 grayscale-[0.2]">
              <PhoneMockup images={[images[1]]} imageOpacities={[1]} className="scale-90 origin-top" />
            </div>
         </div>
         ...
         <div className="container mx-auto px-6 max-w-sm">
            ...
            <div className="flex justify-center -mb-20 opacity-90 grayscale-[0.2]">
              <PhoneMockup images={[images[2]]} imageOpacities={[1]} className="scale-90 origin-top" />
            </div>
         </div>
         ...
         <div className="container mx-auto px-6 max-w-sm">
            ...
            <div className="flex justify-center -mb-20 opacity-90 grayscale-[0.2]">
              <PhoneMockup images={[images[3]]} imageOpacities={[1]} className="scale-90 origin-top" />
            </div>
         </div>
         ...
         <div className="container mx-auto px-6 max-w-sm">
            ...
            <div className="flex justify-center -mb-20 opacity-90 grayscale-[0.2]">
              <PhoneMockup images={[images[4]]} imageOpacities={[1]} className="scale-90 origin-top" />
            </div>
         </div>
         ...
         <div className="container mx-auto px-6 max-w-sm">
            ...
            <div className="flex justify-center pb-20">
              <PhoneMockup images={[images[5]]} imageOpacities={[1]} className="scale-90 origin-top" />
            </div>
         </div>
